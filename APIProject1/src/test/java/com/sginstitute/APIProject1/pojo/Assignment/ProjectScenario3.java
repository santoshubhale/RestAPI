...
public class ProjectScenario3 {
	...
	public void createCustomer()
	{
		try
		{
			...
			Customer customerobj=new Customer("rrnagar", "testyantra", "suhas","ceo","8877889988");
...
public void createProject()
{
	try
	{
		...
		RequestSpecification httpRequest=RestAssured.given();
		//create Pojo class Object
		project projectobject=new project("cosmetic", "tablet", "omege", projectCustomerId);
		ObjectMapper mapper=new ObjectMapper();
...
public void updateProject()
{
	try
	{
		...
		RequestSpecification httpRequest=RestAssured.given();
		//create Pojo class Object
		project projectobject=new project("manufacture", null, null,  projectCustomerId);
		ObjectMapper mapper=new ObjectMapper();
		String jsonproject=mapper.writerWithDefaultPrettyPrinter().writeValueAsString(projectobject);
		httpRequest.header("content-Type", "application/json");
		httpRequest.body(jsonproject);
